...
@SourceType(value = "Sage50UKARP", label = "Sage50UK",uiConfig = "sage50uk-layout.json")
public class Sage50UKConf extends AbstractArpConf<Sage50UKConf> {
  private static final String ARP_FILENAME = "arp/implementation/sage50uk-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.sage50uk.Sage50UKDriver";
